  ...
  return (
    <section className="mt-[5.5rem] max-[680px]:mt-[4.4rem]">
      <div className="flex items-start justify-between gap-[1.5rem] max-[980px]:flex-col">
        <h2 className="m-0 text-[clamp(2rem,3.8vw,3.4rem)] font-medium tracking-[0.01em]">Our Dream to Reality</h2>
        <p className="max-w-[430px] mt-[0.6rem] text-[0.84rem] leading-[1.55] text-white/74 max-[980px]:max-w-none">
          From ipsum dolor meat lovers buffalo. Extra broccoli parmesan risotto
          garlic dolor sauce marinara Chicago marinara.
        </p>
      </div>

      <div className="mt-[2.1rem] grid grid-cols-3 gap-[1.2rem] max-[1220px]:grid-cols-2 max-[680px]:grid-cols-1">
        {FEATURE_CARDS.map((card) => (
          <article className="border border-white/25 bg-[linear-gradient(155deg,rgba(255,255,255,0.1),rgba(255,255,255,0.03))] rounded-[18px] p-[1rem_1rem_1.1rem] min-h-[210px] backdrop-blur-[10px] max-[680px]:min-h-[180px]" key={card.id}>
