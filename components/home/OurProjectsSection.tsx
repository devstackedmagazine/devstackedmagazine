...
export default function OurProjectsSection() {
  return (
    <section className="min-h-screen px-[100px] py-20">
      ...
      <div className="grid grid-cols-2 place-items-center gap-6 mt-5">
        {projects.map((project) => (
          <div
            className="w-[550px] relative overflow-hidden rounded-2xl cursor-pointer border-4 border-transparent transition-all duration-300 ease-out hover:-translate-y-2 hover:border-white/80 hover:shadow-[0_20px_40px_rgba(255,255,255,0.15)]"
            key={project.name}
          >
            <Image
              src={project.image}
